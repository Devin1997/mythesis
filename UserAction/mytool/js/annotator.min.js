...
(function(f) {
    ...
    return function e(t, n, r) {
        ...
        19: [function(require, module, exports) {
            (function() {
                var $, Range, Util, xpath, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
        ...
        30: [function(require, module, exports) {
            ...
            Editor.template = ['<div class="annotator-outer annotator-editor annotator-hide">', '  <form class="annotator-widget">', '    <ul class="annotator-listing"></ul>', '    <div class="annotator-controls">', '     <a href="#save" id="annotator_save_btn" class="annotator-save">' + _t("Save") + "</a>", '      <a id="annotator_vancel_btn" href="#cancel"', '         class="annotator-cancel annotator-focus">' + _t("Cancel") + "</a>", "    </div>", "  </form>", "</div>"].join("\n");
            Editor.options = {
                defaultFields: true
            };
        ...
        36: [function(require, module, exports) {
            (function(global) {
                ...
                TextSelector.prototype.captureDocumentSelection = function() {
                    var i, len, ranges = [], rangesToIgnore = [], selection = global.getSelection();
                    ...
                    for (i = 0,
                    len = rangesToIgnore.length; i < len; i++) {
